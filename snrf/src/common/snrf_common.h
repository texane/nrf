...
#define SNRF_KEY_NRF_CHIPSET 11

#define SNRF_CHIPSET_NRF24L01P 0
#define SNRF_CHIPSET_NRF905 1
...
#define SNRF_RATE_50KBPS 0
#define SNRF_RATE_250KBPS 1
#define SNRF_RATE_1MBPS 2
#define SNRF_RATE_2MBPS 3
